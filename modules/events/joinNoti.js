...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
		...
		return api.sendMessage(`🌟 | ${global.config.BOTNAME} 𝗁𝖺𝗌 𝗌𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝗃𝗈𝗂𝗇𝖾𝖽 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉. 𝖳𝗁𝖺𝗇𝗄 𝗒𝗈𝗎 𝖿𝗈𝗋 𝗂𝗇𝗏𝗂𝗍𝗂𝗇𝗀 𝗆𝖾 𝗂𝗇 𝗍𝗈 𝗒𝗈𝗎𝗋 𝗀𝗋𝗈𝗎𝗉. 𝖨 𝗁𝗈𝗉𝖾 𝗒𝗈𝗎 𝗐𝗂𝗅𝗅 𝖾𝗇𝗃𝗈𝗒 𝗎𝗌𝗂𝗇𝗀 𝗆𝖾. 𝖳𝗁𝖺𝗇𝗄𝗌!\n\n𝖸𝗈𝗎 𝗆𝖺𝗒 𝗎𝗌𝖾 ${global.config.PREFIX}𝗁𝖾𝗅𝗉 𝗍𝗈 𝗌𝖾𝖾 𝗍𝗁𝖾 𝖼𝗈𝗆𝗆𝖺𝗇𝖽𝗌.`, threadID);
	}
	else {
		try {
    const request = require("request");
...
memLength.sort((a, b) => a - b);
			...
			(typeof threadData.customJoin == "undefined") ? msg = "🌟 | 𝖨𝗋𝗋𝖺𝗂𝗌𝗁𝖺𝗂𝗆𝖺𝗌𝖾!, 𝖬𝖺𝗌𝗍𝖾𝗋 {uName}\n╭┉┉┅┉┅┄┄•◦ೋ•◦❥•◦ೋ\n----- 𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝗈 {threadName} -----\n•◦ೋ•◦❥•◦ೋ•┈┄┄┅┉┅┉╯\n𝖸𝗈𝗎 𝖺𝗋𝖾 𝗍𝗁𝖾 {soThanhVien}𝗍𝗁 𝗆𝖾𝗆𝖻𝖾𝗋 𝗈𝖿 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉, 𝖨 𝗁𝗈𝗉𝖾 𝗒𝗈𝗎 𝗐𝗂𝗅𝗅 𝖾𝗇𝗃𝗈𝗒 𝗍𝗁𝗂𝗌 𝗀𝗋𝗈𝗎𝗉 𝖺𝗇𝖽 𝗆𝖾𝖾𝗍 𝗌𝗈𝗆𝖾 𝗇𝖾𝗐 𝖿𝗋𝗂𝖾𝗇𝖽𝗌! 🥳♥" : msg = threadData.customJoin;
			msg = msg
