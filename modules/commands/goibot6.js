...
module.exports.handleEvent = function({ api, event, client, __GLOBAL, Users }) {
	...
	if (event.body.indexOf("maligayang pasko")==0 || (event.body.indexOf("Maligayang Pasko")==0 || (event.body.indexOf("merry christmas")==0 || (event.body.indexOf("Merry christmas")==0)))) {
			api.sendMessage("🙋‍♂️ | 𝖬𝖾𝗋𝗋𝗒 𝖢𝗁𝗋𝗂𝗌𝗍𝗆𝖺𝗌 𝗍𝗈𝗈 𝗆𝖺𝗌𝗍𝖾𝗋.", event.threadID, (e, info) => {
      setTimeout(() => {
