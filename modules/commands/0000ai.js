...
module.exports.run = async function ({ api, event, args }) {
  ...
  api.sendMessage("🕔 | 𝖨𝗆 𝖺𝗆𝗌𝗐𝖾𝗋𝗂𝗇𝗀 𝗒𝗈𝗎𝗋 𝗊𝗎𝖾𝗌𝗍𝗂𝗈𝗇 𝗆𝖺𝗌𝗍𝖾𝗋. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗐𝖺𝗂𝗍.", threadID, messageID);
  ...
  try {
    ...
    if (response.status === 200 && response.data && response.data.message) {
      ...
      api.sendMessage("❎ | 𝖦𝗈𝗆𝖾𝗇 𝗆𝖺𝗌𝗍𝖾𝗋, 𝗍𝗁𝖾𝗋𝖾 𝗂𝗌 𝗇𝗈 𝗋𝖾𝗅𝖾𝗏𝖺𝗇𝗍 𝖺𝗇𝗌𝗐𝖾𝗋 𝖿𝗈𝗋 𝗍𝗁𝖺𝗍, 𝗉𝗅𝖾𝖺𝗌𝖾 𝖻𝖾 𝗌𝗉𝖾𝖼𝗂𝖿𝗂𝖼 𝗍𝗈 𝗒𝗈𝗎𝗋 𝗊𝗎𝖾𝗌𝗍𝗂𝗈𝗇.", threadID, messageID);
    }
  } catch (error) {
    console.error(error);
