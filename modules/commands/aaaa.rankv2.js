...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
  ...
  if (args.length == 0) {
    ...
    if (rank == 0) return api.sendMessage("❎ | 𝖲𝖾𝗇𝗌𝖾𝗂, 𝗒𝗈𝗎 𝖺𝗋𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗇𝗈𝗍 𝗂𝗇 𝗍𝗁𝖾 𝖽𝖺𝗍𝖺𝖻𝖺𝗌𝖾 𝗌𝗈 𝖼𝖺𝗇'𝗍 𝗌𝖾𝖾 𝗒𝗈𝗎𝗋 𝗋𝖺𝗇𝗄, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗍𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 𝗂𝗇 𝟧 𝗌𝖾𝖼𝗈𝗇𝖽𝗌.", event.threadID, event.messageID);
  ...
  if (mention.length > 1) {
    for (const userID of mention) {
      ...
      if (rank == 0) return api.sendMessage("❎ | 𝖬𝖺𝗌𝗍𝖾𝗋, 𝗒𝗈𝗎 𝖺𝗋𝖾 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗇𝗈𝗍 𝗂𝗇 𝗍𝗁𝖾 𝖽𝖺𝗍𝖺𝖻𝖺𝗌𝖾 𝗌𝗈 𝖼𝖺𝗇'𝗍 𝗌𝖾𝖾 𝗒𝗈𝗎𝗋 𝗋𝖺𝗇𝗄, 𝗉𝗅𝖾𝖺𝗌𝖾 𝗍𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 𝗂𝗇 𝟧 𝗌𝖾𝖼𝗈𝗇𝖽𝗌.", event.threadID, event.messageID);
